...
@objc protocol SwiftJavaScriptDelegate: JSExport {
    ...
    static func WebViewJavascriptBridge()
...
@objc class SwiftJavaScriptModel: NSObject, SwiftJavaScriptDelegate {
    ...
    class func WebViewJavascriptBridge()  {
...
class ViewController: UIViewController, UIWebViewDelegate {
    ...
    func webViewDidFinishLoad(_ webView: UIWebView) {
        ...
        self.jsContext.setObject(unsafeBitCast(temp1, to: AnyObject.self), forKeyedSubscript: "WebViewJavascriptBridge" as (NSCopying & NSObjectProtocol)!)
        
        
        // 这一步是将SwiftJavaScriptModel模型注入到JS中，在JS就可以通过WebViewJavascriptBridge调用我们暴露的方法了。
//        self.jsContext.setObject("", forKeyedSubscript: "WebViewJavascriptBridge" as (NSCopying & NSObjectProtocol)!)
